...
# YOUR_NAME="lucaslee" # ex: honggildong
# YOUR_HOME_PATH="/home/lucaslee" # ex: /home/honggildong
...
echo "[System] run train_cifar.py with 'run_ddp_dali.sh'..."
docker exec ${DOCKER_NAME} bash -c "cd /HOME && bash scripts/run_ddp_dali.sh"
